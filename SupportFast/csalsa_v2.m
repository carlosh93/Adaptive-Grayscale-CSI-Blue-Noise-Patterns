...
%
% ========================================================
function [x, numA, numAt, objective, distance1, distance2, criterion, times, mses] = csalsa_v2(y, A, mu1, mu2, sigma, varargin)
...
% if psi was given, check to see if it is a handle and that it 
